...
--
-- Nothing here is engine-specific: the column types are the portable TEXT the rest of
-- the schema uses, and no DEFAULT is needed because the writer binds both values.
